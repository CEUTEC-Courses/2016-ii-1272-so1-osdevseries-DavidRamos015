; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\so1\Desktop\OS Development series 14 - 19\Tutorial 17\SysCore\Kernel\DebugDisplay.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\so1\desktop\os development series 14 - 19\tutorial 17\syscore\kernel\debugdisplay.cpp
...
_TEXT	SEGMENT
_str$2728 = -64						; size = 64
_str$2749 = -32						; size = 32
_str$2739 = -32						; size = 32
_str$ = 8						; size = 4
...
; 282  : 						char str[32]={0};
	...
	pop	ecx
	xor	eax, eax
	mov	BYTE PTR _str$2749[ebp], 0
	lea	edi, DWORD PTR _str$2749[ebp+1]
	rep stosd
	stosw
	stosb
...
; 283  : 						itoa_s (c,16,str);
	...
	lea	eax, DWORD PTR _str$2749[ebp]
	push	eax
	push	16					; 00000010H
$LN25@DebugPrint:
	add	esi, 4
...
; 261  : 						strcpy (str,(const char*)c);
	...
	push	DWORD PTR [esi]
	lea	eax, DWORD PTR _str$2728[ebp]
	push	eax
...
; 271  : 						char str[32]={0};
	...
	pop	ecx
	xor	eax, eax
	mov	BYTE PTR _str$2739[ebp], 0
	lea	edi, DWORD PTR _str$2739[ebp+1]
	rep stosd
	stosw
	stosb
...
; 272  : 						itoa_s (c, 10, str);
	...
	lea	eax, DWORD PTR _str$2739[ebp]
	push	eax
	push	10					; 0000000aH
